...
namespace StudioBooking.Areas.Identity.Pages.Account
{
	public class RegisterModel : PageModel
	{
		...
		public async Task<IActionResult> OnPostAsync(string returnUrl = null)
		{
			...
			{
				var user = CreateUser();
				var email = string.IsNullOrEmpty(Input.Email) ? "rb" + Input.Mobile + "@rbstudios.info" : Input.Email;
				await _userStore.SetUserNameAsync(user, Input.Mobile ?? email, CancellationToken.None);
				...
				if (result.Succeeded)
				{
					...
					var customer = await Customer.AddCustomer(_context, user, new CustomerDTO
					{
						UserId = user.Id,
					...
					{
						_logger.LogError(ex, "Error at registeration");
					}
