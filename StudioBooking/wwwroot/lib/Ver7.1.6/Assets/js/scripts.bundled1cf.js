...
var KTToggle = function (t, e, a) {
    ...
    if (i) {
        var l = {
            ...
            , r = {
                construct: function (t) {
                    return KTUtil.data(i).has("toggle") ? n = KTUtil.data(i).get("toggle") : (r.init(t),
                        r.build(),
                ...
                init: function (t) {
                    n.element = i,
                        ...
                        "class" == n.options.targetToggleMode ? n.state = KTUtil.hasClasses(n.target, n.targetState) ? "on" : "off" : n.state = KTUtil.hasAttr(n.target, "data-" + n.targetState) ? KTUtil.attr(n.target, "data-" + n.targetState) : "off"
                },
                build: function () {
                    KTUtil.addEvent(i, "mouseup", r.toggle)
                },
                toggle: function (t) {
                    return r.eventTrigger("beforeToggle"),
                ...
                toggleOn: function () {
                    return r.eventTrigger("beforeOn"),
                        "class" == n.options.targetToggleMode ? KTUtil.addClass(n.target, n.targetState) : KTUtil.attr(n.target, "data-" + n.targetState, "on"),
                ...
                toggleOff: function () {
                    return r.eventTrigger("beforeOff"),
                        "class" == n.options.targetToggleMode ? KTUtil.removeClass(n.target, n.targetState) : KTUtil.removeAttr(n.target, "data-" + n.targetState),
                ...
                eventTrigger: function (t) {
                    for (var e = 0; e < n.events.length; e++) {
                        ...
                        if (a.name == t) {
                            if (1 != a.one)
                                return a.handler.call(this, n);
                            if (0 == a.fired)
                                return n.events[e].fired = !0,
...
var KTUtil = function () {
    ...
    return {
        ...
        outerHeight: function (t, e) {
            ...
            return void 0 !== e && !0 === e ? (a = getComputedStyle(t),
        ...
        btnWait: function (t, e, a, n) {
            if (t && (void 0 !== n && !0 === n && KTUtil.attr(t, "disabled", !0),
                            ...
                            populate: function () {
                                if (o.dataSet = o.dataSet || [],
                                    ...
                                    t("<li/>").append(t("<a/>").attr("title", a.next).addClass("datatable-pager-link datatable-pager-link-next").append(t("<i/>").addClass(e.next)).on("click", i.gotoMorePage)).appendTo(n),
                                        ...
                                        l.getOption("toolbar.items.info") && (i.pagerLayout.info = t("<div/>").addClass("datatable-pager-info my-2 mb-sm-0").append(t("<span/>").addClass("datatable-pager-detail"))),
...
KTUtil.isRTL() && (defaults = {
    ...
    KTUtil.ready((function () {
        void 0 !== KTLayoutHeader && KTLayoutHeader.init("kt_header", "kt_header_mobile"),
            void 0 !== KTLayoutHeaderMenu && KTLayoutHeaderMenu.init("kt_header_menu", "kt_header_menu_wrapper"),
            void 0 !== KTLayoutHeaderTopbar && KTLayoutHeaderTopbar.init("kt_header_mobile_topbar_toggle"),
            void 0 !== KTLayoutBrand && KTLayoutBrand.init("kt_brand"),
            void 0 !== KTLayoutAside && KTLayoutAside.init("kt_aside"),
            void 0 !== KTLayoutAsideToggle && KTLayoutAsideToggle.init("kt_aside_toggle"),
            ...
            void 0 !== KTLayoutStickyCard && KTLayoutStickyCard.init("kt_page_sticky_card"),
            void 0 !== KTLayoutStretchedCard && KTLayoutStretchedCard.init("kt_page_stretched_card"),
            ...
            void 0 !== KTLayoutQuickActions && KTLayoutQuickActions.init("kt_quick_actions"),
            void 0 !== KTLayoutQuickNotifications && KTLayoutQuickNotifications.init("kt_quick_notifications"),
            void 0 !== KTLayoutQuickPanel && KTLayoutQuickPanel.init("kt_quick_panel"),
            void 0 !== KTLayoutQuickUser && KTLayoutQuickUser.init("kt_quick_user"),
            void 0 !== KTLayoutQuickSearch && KTLayoutQuickSearch.init("kt_quick_search"),
            void 0 !== KTLayoutQuickCartPanel && KTLayoutQuickCartPanel.init("kt_quick_cart"),
            void 0 !== KTLayoutSearch && KTLayoutSearch().init("kt_quick_search_dropdown"),
            void 0 !== KTLayoutSearchOffcanvas && KTLayoutSearchOffcanvas().init("kt_quick_search_offcanvas")
    }
    ));
var KTLayoutAsideMenu = function () {
    ...
    return {
        init: function (n) {
            var i, o, l, r;
            (t = KTUtil.getBody(),
                e = KTUtil.getById(n)) && (o = "1" === KTUtil.attr(e, "data-menu-dropdown") ? "dropdown" : "accordion",
                    "1" === KTUtil.attr(e, "data-menu-scroll") && (i = {
                        rememberPosition: !0,
                        height: function () {
                            var t = parseInt(KTUtil.getViewPort().height);
                            return KTUtil.isBreakpointUp("lg") && (t -= KTLayoutBrand.getHeight()),
                    ...
                    KTUtil.hasClass(t, "aside-fixed") && KTUtil.hasClass(t, "aside-minimize-hoverable") && (KTUtil.addEvent(e, "mouseenter", (function (e) {
                        e.preventDefault(),
                            !1 !== KTUtil.isBreakpointUp("lg") && (r && (clearTimeout(r),
                                r = null),
                                l && (clearTimeout(l),
                                    l = null),
                                l = setTimeout((function () {
                                    KTUtil.hasClass(t, "aside-minimize") && KTUtil.isBreakpointUp("lg") && (KTUtil.addClass(t, "aside-minimize-hover"),
                        ...
                        KTUtil.addEvent(KTLayoutAside.getElement(), "mouseleave", (function (e) {
                            e.preventDefault(),
                                !1 !== KTUtil.isBreakpointUp("lg") && (l && (clearTimeout(l),
                                    l = null),
                                    r && (clearTimeout(r),
                                        r = null),
...
var KTLayoutAside = function () {
    ...
    return {
        init: function (n) {
            ...
            (e = KTUtil.getById(n),
                t = KTUtil.getBody(),
                e) && (i = KTUtil.hasClass(e, "aside-offcanvas-default") ? "aside-offcanvas-default" : "aside",
                    a = new KTOffcanvas(e, {
                        baseClass: i,
                        overlay: !0,
...
var KTLayoutExamples = {
    init: function (t, e) {
        !function (t) {
            var e = t;
            if (void 0 === e && (e = document.querySelectorAll(".example:not(.example-compact):not(.example-hover):not(.example-basic)")),
                e && e.length > 0)
...
var KTLayoutSearch = function () {
    var t, e, a, n, i, o, l, r, s = "", d = !1, c = !1, u = !1, p = "spinner spinner-sm spinner-primary", f = "quick-search-has-result", g = function () {
        u = !1,
