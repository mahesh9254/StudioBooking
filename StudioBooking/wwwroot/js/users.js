    ...
    init: function () {
        ...
        t = $(".kt-datatable").KTDatatable({
            data: {
                ...
                source: {
                    read: {
                        url: location.protocol + "//" + location.host + "/Admin/Account/UserList",
                        method: 'GET',
                        map: function (t) {
                            var e = t;
            ...
            columns: [{
                ...
                template: function (t) {
                    ...
                    let html = ''
                    $.each(t.roles, function (i) {
                        html += '<span class="label label-' + e[t.roles[i]].class + ' label-pill label-inline">' + e[t.roles[i]].title + '</span>'
                    })
                    return html;
                }
            },
