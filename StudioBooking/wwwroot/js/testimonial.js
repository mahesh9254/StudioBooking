    ...
    init: function () {
        ...
        t = $(".kt-datatable").KTDatatable({
            data: {
                ...
                source: {
                    read: {
                        url: location.protocol + "//" + location.host + "/Admin/Testimonial/GetTestimonials",
                        method: 'GET',
                        map: function (t) {
                            var e = t;
            ...
            },
            {
                ...
                title: "Image",
                template: function (t) {
                    if (t.image) { return '<img alt="Team Image" style="max-width:100px;" src="' + t.image + '" />' } else return "";
                }
            }, {
                field: "name",
                title: "Name",
            ...
            },
            {
                ...
                template: function (t) {
                    ...
                    html += '<a href="/Admin/Testimonial/Edit/' + t.id + '" class="dropdown-item" title="Edit"><i class="flaticon2-edit"></i><span style="margin: 3px;">Edit</span></a>';
                    html += '<a href="javascript:;" id="btnDelete" class="dropdown-item" data-target="' + t.id + '" controller="Admin/Testimonial" action="Delete" title="Delete"><i class="flaticon2-trash"></i><span style="margin: 3px;">Delete</span></a>';
                    html += '</div></div>';
                    return html;
                }
            }]
