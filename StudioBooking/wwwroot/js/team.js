    ...
    init: function () {
        ...
        t = $(".kt-datatable").KTDatatable({
            data: {
                ...
                source: {
                    read: {
                        url: location.protocol + "//" + location.host + "/Admin/Team/GetTeams",
                        method: 'GET',
                        map: function (t) {
                            var e = t;
            ...
            },
            {
                ...
                template: function (t) {
                    ...
                    html += '<a href="/Admin/Team/Edit/' + t.id + '" class="dropdown-item" title="Edit"><i class="flaticon2-edit"></i><span style="margin: 3px;">Edit</span></a>';                    
                    html += '<a href="javascript:;" id="btnDelete" class="dropdown-item" data-target="' + t.id + '" controller="Admin/Team" action="Delete" title="Delete"><i class="flaticon2-trash"></i><span style="margin: 3px;">Delete</span></a>';
                    html += '</div></div>';
                    return html;
                }
            }]
